...
export default function AdminWallet() {
  ...
  const loadCoins = async () => {
    await axios.get(urlCoins).then((response) => setListedCoins(response.data));
  };
  ...
  const loadOneWallet = async (id) => {
    ...
    console.log({ id });
    await axios.get(`${urlAdminWallet}/${wal?.id}`).then((response) => {
  ...
  const editWallets = async (data) => {
    try {
      ...
      const res = await axios.put(
        `${urlAdminWallet}/${editWalletData?.id}`,
        obj
      );
      if (res?.data?.successmessage) {
        successMessage(res?.data?.successmessage);
                ...
                <div className="card mb-4 mb-lg-0">
                  <div className="card-body p-0">
                    <div className="row d-flex float-right mr-4">
                      <p className="text-dark font-weight-bold mr-2 mt-2">
                        Add Wallet
                      </p>
                      <i
                    ...
                    <ul className="list-group list-group-flush rounded-3">
                      {wallet && wallet.find((x) => x.coin === coins.BTC) && (
                        <li className="list-group-item d-flex justify-content-between align-items-center p-3">
                          ...
                          <p
                            className=" text-dark mb-0 text-wrap"
                            style={{ width: "255px" }}
                          >
                            {addresses.bitcoin.walletAddress}
                          </p>
                          <div className="d-flex justify-content-between">
                            <i
                      ...
                      {wallet && wallet.find((x) => x.coin === coins.ETH) && (
                        <li className="list-group-item d-flex justify-content-between align-items-center p-3">
                          ...
                          <p
                            ...
                            style={{ width: "255px" }}
                          >
                            {addresses.ethereum.walletAddress}
                          </p>
                          <div className="d-flex justify-content-between">
                            <i
                      ...
                      {wallet && wallet.find((x) => x.coin === coins.LTC) && (
                        <li className="list-group-item d-flex justify-content-between align-items-center p-3">
                          ...
                          <p
                            ...
                            style={{ width: "255px" }}
                          >
                            {addresses.litecoin.walletAddress}
                          </p>
                          <div className="d-flex justify-content-between">
                            <i
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              {!paid && 
                <button
                  onClick={handleSubmit(saveWallet)}
                  type="button"
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button
                onClick={handleSubmit2(editWallets)}
                type="button"
                className="btn btn-primary"
              >
                Save
