        ...
        <div className="card mb-4">
          <div className="card-body">
            <form>
              ...
              <div className="form-outline mb-4">
                <select placeholder="coin" typeof="text" className="text-dark form-control">
                  <option value="bitcoin" className="text-dark">Bitcoin</option>
                  <option value="ethereum" className="text-dark">Ethereum</option>
                  <option value="shiba" className="text-dark">
                    Shiba Inu
                  </option>
                  <option value="doge" className="text-dark">Dogecoin</option>
                </select>
