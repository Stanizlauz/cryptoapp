  ...
  const coins = [
    {
      ...
      coin: "Bitcoin",
      address: <textarea readOnly value="btcjhdjdkdiirirkf" />,
    },
    {
            ...
            <section className="our-webcoderskull padding-lg bg-light">
              <div className="my_alert">
                <div className="alert alert-info mx-2">
                  You have chosen {data?.plan} plan. Please select your desired coin.
                  Note: plan ranges from {data?.message}
                  <i
                      ...
                      <div className="modal-content">
                        ...
                        <div className="modal-body">
                          ...
                          <div className="mt-3 mb-3 text-dark">
                            In order to confirm payment. A proof of payment have
                            to be uploaded.
                          </div>
